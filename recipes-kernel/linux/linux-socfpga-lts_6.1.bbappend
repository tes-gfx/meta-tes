...
ADDSOURCES:tesdavenx:tesintern = "\
	...
	${TES_SVN_PATH};module=driver/kernel/linux/drm-dnx;path_spec=drm-dnx;name=drm;protocol=https;user=${TES_SVN_USER};pswd=${TES_SVN_PASSWORD} \
"
